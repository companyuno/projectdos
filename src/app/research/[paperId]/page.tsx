...
interface ResearchPaperContent {
  ...
  studioWedges?: Array<{ title: string; thesis: string; fulfillmentRole?: string; studioAdvantage?: string; pharmacyAdvantage?: string; pharmacyRole?: string; applicableConditions?: string; studioFit?: string; competitors?: string }>;
  ...
  studioFitTest?: {
    structuralInefficiency: { laborIntensive: string; techStarved: string; fragmented: string };
    buildFeasibility: { favorable: string; avoid: string };
    wedgeDefensibility: { strong: string; weak: string };
    capitalEfficiency: string;
    returnPotential: string;
  };
  productWedges?: Array<{ name: string; description: string; buyer: string; market: string; pricing: string; acv: string; competitiveWhitespace: string; verdict: string }>;
  summaryTable?: Array<{ wedge: string; marketSize: string; buyerStrength: string; competitiveWhiteSpace: string; studioFit: string }>;
  conclusion?: string;
  nextSteps?: string[];
}
...
export default function ResearchPaper() {
  ...
  const paper = researchContent[paperId] as ResearchPaper;
    ...
    <div className="min-h-screen bg-gray-50 text-foreground">
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">{(paper as ResearchPaper).title}</h1>
        </div>
        <Card>
          <CardContent className="space-y-8">
            ...
            {(paper as ResearchPaper).content?.investorSummary && (
              <div>
                <h3 className="text-xl font-semibold mb-4">Investor Summary</h3>
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                  <p className="text-gray-700 leading-relaxed whitespace-pre-line">{(paper as ResearchPaper).content?.investorSummary}</p>
                </div>
              </div>
            )}

            {/* Industry Structure */}
            {(paper as ResearchPaper).content?.industryStructure && (
              <div>
            ...
            {(paper as ResearchPaper).content?.studioFilter && (
              <div>
            ...
            {(paper as ResearchPaper).content?.workflowDecomposition && (
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      {(paper as ResearchPaper).content?.workflowDecomposition.map((row: { stage: string; description: string; keyRisk: string; invitroControl: string }, index: number) => (
                        <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
            ...
            {/* Studio Wedges */}
            {(paper as ResearchPaper).content?.studioWedges && (
              <div>
                <h3 className="text-xl font-semibold mb-4">IV. Studio Wedges Anchored to Drug Delivery Workflow</h3>
                <div className="space-y-6">
                  {(paper as ResearchPaper).content?.studioWedges.map((wedge: { title: string; thesis: string; fulfillmentRole?: string; studioAdvantage?: string; pharmacyAdvantage?: string; pharmacyRole?: string; applicableConditions?: string; studioFit?: string; competitors?: string }, index: number) => (
                    <div
                      key={index}
            ...
            {/* Summary */}
            {(paper as ResearchPaper).content?.summary && (
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      {(paper as ResearchPaper).content?.summary.map((row: { wedge: string; currentPractice: string; studioAdvantage: string }, index: number) => (
                        <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
            ...
            {(paper as ResearchPaper).content?.marketSubsegmentation && (
              <div>
                ...
                <div className="overflow-x-auto mb-4">
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      {(paper as ResearchPaper).content?.marketSubsegmentation.map((row: { subsegment: string; description: string; targetUser: string; primaryBuyer: string; examples: string }, index: number) => (
                        <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
            ...
            {(paper as ResearchPaper).content?.studioFitTest && (
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-red-50 p-6 rounded-lg border border-red-200">
                    ...
                    <div className="space-y-3">
                      <div><span className="font-semibold text-red-800">Labor-Intensive: </span><span className="text-red-700">{(paper as ResearchPaper).content?.studioFitTest?.structuralInefficiency?.laborIntensive}</span></div>
                      <div><span className="font-semibold text-red-800">Tech-Starved: </span><span className="text-red-700">{(paper as ResearchPaper).content?.studioFitTest?.structuralInefficiency?.techStarved}</span></div>
                      <div><span className="font-semibold text-red-800">Fragmented: </span><span className="text-red-700">{(paper as ResearchPaper).content?.studioFitTest?.structuralInefficiency?.fragmented}</span></div>
                    </div>
                  </div>
                  <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                    <h4 className="text-lg font-semibold text-blue-800 mb-4">2. Build Feasibility</h4>
                    <div className="space-y-3">
                      <div><span className="font-semibold text-blue-800">Favorable: </span><span className="text-blue-700">{(paper as ResearchPaper).content?.studioFitTest?.buildFeasibility?.favorable}</span></div>
                      <div><span className="font-semibold text-blue-800">Avoid: </span><span className="text-blue-700">{(paper as ResearchPaper).content?.studioFitTest?.buildFeasibility?.avoid}</span></div>
                    </div>
                  </div>
                  <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                    <h4 className="text-lg font-semibold text-green-800 mb-4">3. Wedge Defensibility</h4>
                    <div className="space-y-3">
                      <div><span className="font-semibold text-green-800">Strong: </span><span className="text-green-700">{(paper as ResearchPaper).content?.studioFitTest?.wedgeDefensibility?.strong}</span></div>
                      <div><span className="font-semibold text-green-800">Weak: </span><span className="text-green-700">{(paper as ResearchPaper).content?.studioFitTest?.wedgeDefensibility?.weak}</span></div>
                    </div>
                  </div>
                  <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                    <h4 className="text-lg font-semibold text-yellow-800 mb-4">4. Capital Efficiency</h4>
                    <p className="text-yellow-700">{(paper as ResearchPaper).content?.studioFitTest?.capitalEfficiency}</p>
                  </div>
                  <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                    <h4 className="text-lg font-semibold text-purple-800 mb-4">5. Return Potential</h4>
                    <p className="text-purple-700">{(paper as ResearchPaper).content?.studioFitTest?.returnPotential}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            {(paper as ResearchPaper).content?.productWedges && (
              <div>
                <h3 className="text-xl font-semibold mb-4">III. Defensible Product Wedges in Healthcare E-Learning</h3>
                <div className="space-y-8">
                  {(paper as ResearchPaper).content?.productWedges.map((wedge: { name: string; description: string; buyer: string; market: string; pricing: string; acv: string; competitiveWhitespace: string; verdict: string }, index: number) => (
                    <div
                      key={index}
            ...
            {(paper as ResearchPaper).content?.summaryTable && (
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      {(paper as ResearchPaper).content?.summaryTable.map((row: { wedge: string; marketSize: string; buyerStrength: string; competitiveWhiteSpace: string; studioFit: string }, index: number) => (
                        <tr key={index} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                          <td className="border border-gray-300 px-4 py-3 font-medium text-gray-800">{row.wedge}</td>
            ...
            {(paper as ResearchPaper).content?.conclusion && (paper as ResearchPaper).content?.marketSubsegmentation && (
              <div>
                <h3 className="text-xl font-semibold mb-4">V. Conclusion: Build the Infrastructure, Not the Content</h3>
                <div className="space-y-6">
                  <p className="text-gray-700 leading-relaxed whitespace-pre-line">{(paper as ResearchPaper).content?.conclusion}</p>
                </div>
              </div>
            )}
            ...
            {(paper as ResearchPaper).content?.conclusion && !(paper as ResearchPaper).content?.marketSubsegmentation && (
              <div>
                ...
                <div className="space-y-6">
                  ...
                  {(paper as ResearchPaper).content?.nextSteps && (
                    <div>
                      ...
                      <ol className="space-y-3">
                        {(paper as ResearchPaper).content?.nextSteps.map((step: string, index: number) => (
            ...
            {!(paper as ResearchPaper).content?.conclusion && (
